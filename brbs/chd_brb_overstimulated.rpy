...
label chd_brb_overstimulated_callback:
    if mas_brbs.was_idle_for_at_least(datetime.timedelta(minutes=200), "chd_brb_overstimulated"):
    ...
    elif mas_brbs.was_idle_for_at_least(datetime.timedelta(minutes=30), "chd_brb_overstimulated"):
        m 1hub "Welcome back!"
