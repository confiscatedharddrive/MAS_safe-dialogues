#Thank you for making me feel safe, compliment submod by confiscatedharddrive and my-otter-self for Monika After Story.

init 5 python in mas_bookmarks_derand:
    label_prefix_map["chd_otter_compliment_"] = label_prefix_map["monika_"]

init 5 python:
    addEvent(
        Event(
            persistent.event_database,
            eventlabel="chd_otter_compliment_feel_safe",
...
label chd_otter_compliment_feel_safe:
    ...
    m 2dkd "I just wish there was more I could do to help you when you need me."
    ...
    m 7hksdlb "Ahahaha, sorry. Was that a bit much?"
    m 2dsc "..."
